#ifndef TESTS_HMCONTROLLINUXSOCKET6_H_
#define TESTS_HMCONTROLLINUXSOCKET6_H_
...
#define TESTNAME Test_HMControlLinuxSocket6
...
#endif /* TESTS_HMCONTROLLINUXSOCKET6_H_ */
