...
#include "TestHMControlTLSSocket3.h"
...
{
	HMControlTLSSocketClient socketAPI(serverv4, portv4, certfile, keyfile, caFile);
...
{
	string hostGroupName = "config.parse1.netchasm.net";
	HMControlTLSSocketClient socketAPI(serverv6, portv6, certfile, keyfile, caFile);
	HMAPICheckInfo checkInfo;
	vector<HMAPICheckResult> results;
	HMAPIIPAddress addr;
	string ipaddr = "192.168.1.3";
...
{
	string hostGroupName = "config.parse1.netchasm.net";
	HMControlTLSSocketClient socketAPI(serverv4, portv6, certfile, keyfile, caFile);
	HMAPICheckInfo checkInfo;
	vector<HMAPICheckResult> results;
	HMAPIIPAddress addr;
	string ipaddr = "192.168.1.3";
