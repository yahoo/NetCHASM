...
#ifndef TESTS_HMTLSCONNECTIONHANDLERSOCKET1_H_
#define TESTS_HMTLSCONNECTIONHANDLERSOCKET1_H_
...
#define TESTNAME Test_HMTLSConnectionHandler1
...
#endif /* TESTS_HMTLSCONNECTIONHANDLERSOCKET1_H_ */
