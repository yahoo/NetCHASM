...
#ifndef TESTS_WORKTESTS_TESTHMWORKREMOTEHOSTCHECK_H_
#define TESTS_WORKTESTS_TESTHMWORKREMOTEHOSTCHECK_H_
...
#define TESTNAME Test_HMWorkRemoteHostCheck


class TestHMWorkRemoteHostCheck : public HMWorkRemoteHostCheck
{
public:
    TestHMWorkRemoteHostCheck(const std::string& hostname, const HMIPAddress& ip, const HMDataHostCheck& datahostCheck, const std::multimap<HMDataCheckParams, HMDataCheckResult>& results) :
        HMWorkRemoteHostCheck(hostname, ip, datahostCheck) {responseTime = 0; m_hostResults = results;};
...
class TESTNAME : public CppUnit::TestFixture
{
    ...
    CPPUNIT_TEST(test_HMWorkRemoteCheck_mixed_remote_host_remote_hostgroup);
...
public:
    ...
    TestHMWorkRemoteCheck* remoteGroupCheck;
    TestHMWorkRemoteHostCheck* remoteCheck;
...
protected:
    ...
    void test_HMWorkRemoteCheck_mixed_remote_host_remote_hostgroup();
};
#endif /* TESTS_WORKTESTS_TESTHMWORKREMOTEHOSTCHECK_H_ */
