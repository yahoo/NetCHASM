...
slimbuild:
	mkdir -p build; cd build; cmake .. -DCMAKE_CXX_COMPILER=g++ -DCMAKE_C_COMPILER=gcc -DSKIP-MDBM=ON -DSKIP-LIBEVENT=ON -DSKIP-ARES=ON -DSKIP-RAPIDXML=ON -DCMAKE_INSTALL_PREFIX=/bin; make build
