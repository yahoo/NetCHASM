...
#ifndef HMWORKREMOTECHECKREMOTE_H_
#define HMWORKREMOTECHECKREMOTE_H_

class HMWorkRemoteCheckRemote : public HMWorkRemoteCheck
{

public:

    HMWorkRemoteCheckRemote(const std::string& hostname, const HMIPAddress& ip, const HMDataHostCheck& datahostcheck, const HMDataHostGroup& datahostGroup) :
        HMWorkRemoteCheck(hostname, ip, datahostcheck, datahostGroup) {};
...
#endif /* HMWORKREMOTECHECKREMOTE_H_ */
