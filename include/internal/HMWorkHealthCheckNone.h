...
#ifndef HMWORKHEALTHCHECKNONE_H_
#define HMWORKHEALTHCHECKNONE_H_

#include "HMWorkHealthCheck.h"

// LCOV_EXCL_START; Tested in functional testing
//! Health Check Implementation to check none. ie always up.
class HMWorkHealthCheckNone : public HMWorkHealthCheck
{
public:
    HMWorkHealthCheckNone(const std::string& hostname, const HMIPAddress& ip, const HMDataHostCheck& hostcheck) :
...
#endif /* HMWORKHEALTHCHECKNONE_H_ */
