...
#ifndef HMSTORAGEHOSTNOTIFIER_H
#define HMSTORAGEHOSTNOTIFIER_H

#include "HMStorageHost.h"
#include "HMStorageObserver.h"
#include "HMDataCheckParams.h"
// Storage class that notifies observers of probe state changes.
// The observers are passed at the time the object of this class is instantiated.
// This model allows dynamic instantiation of different observers types.
class HMStorageHostNotifier : public HMStorageHost
{
public:
    HMStorageHostNotifier( HMDataHostGroupMap* hostGroupMap,
          HMDNSCache* dnsCache) :
        HMStorageHost(hostGroupMap, dnsCache) {};

    virtual ~HMStorageHostNotifier() {};
