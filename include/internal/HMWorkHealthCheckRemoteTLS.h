...
#ifndef HMWORKHEALTHCHECKREMOTETLS_H_
#define HMWORKHEALTHCHECKREMOTETLS_H_
 ...
 */
class HMWorkHealthCheckRemoteTLS : public HMWorkHealthCheck
{
public:
    HMWorkHealthCheckRemoteTLS(const std::string& hostname, const HMIPAddress& ip, const HMDataHostCheck& hostcheck) :
...
#endif /* HMWORKHEALTHCHECKREMOTETLS_H_ */
